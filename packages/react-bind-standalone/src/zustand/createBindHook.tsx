...
import { useBind, type ReactBindExtendedApi } from "./useBind.js";
import type { BindOptions, ElementContext } from "./types.js";
						...
						{(ctx: ElementContext<TValues>) => {
							...
							return (
								<elementContext.Provider
									value={ctx as ElementContext<readonly string[]>}
								>
